...
### Xác định phần xóa bỏ như thế nào

Quy trình thu hồi bộ nhớ được chia làm 2 giai đoạn là mark và sweep. Trong pha mark, bộ dọn rác sử dụng thuật toán 3 màu để xác định block nào không còn được sử dụng nữa.
